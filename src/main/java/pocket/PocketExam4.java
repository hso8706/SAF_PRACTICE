...
//import java.io.;
//
//public class PocketExam4 {
//
//    닉네임을 사용자에 맞게 변경해 주세요.
//    static final String NICKNAME = PocketExam4;
//
...
//    }
//
//    static ArrayListDouble[] getCandidate(float[] myPos, float[] ballPos, int ballIdx, float[][] balls) { myPos가
//            ballIdx에
//        해당하는 공을 칠
//                때,
//        6가지 모든
...
//        거리를 후보에
//        저장
//        ArrayListDouble[] candidate = new ArrayList();
//        if (ballIdx == 5) {
...
//            continue;
//            ArrayListDouble[] temp = getCandidate(myPos, balls[i], i, balls);
//            for (Double[] a  temp) {
//                candidate.add(a);
//            }
//        }
//        ComparatorDouble[] comparator = new ComparatorDouble[]() {
//
//            @Override
...
//            os.write(bytes);
//            os.flush();
//            System.out.println(Ready to play!n--------------------);
//
//            while (socket != null) {
//
//                Receive Data
...
//                    order = (int) balls[0][1];
//                    System.out.println(n You will be the  + (order == 1  first  second) +  player. n);
//                    continue;
